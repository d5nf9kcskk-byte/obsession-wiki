...
//
// This is a plain-JavaScript copy of src/index.ts so you can paste it straight
// into the Cloudflare dashboard editor (Workers & Pages -> your worker ->
// "Edit code") with no build step.
//
